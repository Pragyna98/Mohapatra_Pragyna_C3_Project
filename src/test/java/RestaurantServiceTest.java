...
class RestaurantServiceTest {
    ...
    public void setup(){
        ...
        restaurant.addToMenu("Momos", 99);
        restaurant.addToMenu("Fried Chicken", 199);
        restaurant.addToMenu("Noodles", 149);
    }
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object() throws restaurantNotFoundException {
        ...
        boolean isRestaurantFound = service.findRestaurantByName(restaurantName) != null;
        assertTrue(isRestaurantFound);
